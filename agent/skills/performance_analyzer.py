...
class PerformanceAnalyzer:
    ...
    def generate_optimization_report(
        ...
        if suggestions:
            ...
            for idx, suggestion in enumerate(suggestions[:8], 1):  # Show top 8
                ...
                report += (
                    f"- **Priority:** {suggestion.get('priority', 'medium').title()}\n"
                )
    ...
    def _estimate_big_o_complexity(
        self, code: str, language: Optional[str]
    ) -> List[Dict]:
    ...
    def _suggest_algorithm_improvements(
        self, code: str, language: Optional[str]
    ) -> List[Dict]:
    ...
    def _suggest_data_structure_improvements(
        self, code: str, language: Optional[str]
    ) -> List[Dict]:
    ...
    def _suggest_caching_opportunities(
        self, code: str, language: Optional[str]
    ) -> List[Dict]:
