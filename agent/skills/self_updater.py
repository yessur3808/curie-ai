...
class SelfUpdater:
    ...
    def check_for_updates(self, branch: str = "main") -> Dict[str, Any]:
        ...
        try:
            ...
            if updates_available:
                commits_behind = list(
                    self.repo.iter_commits(f"{local_commit}..{remote_commit}")
                )
    ...
    def pull_updates(self, branch: str = "main", force: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "branch": branch, "pull_info": str(pull_info)}
    ...
    def rollback(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"success": True, "message": f"Rolled back to {self.backup_branch}"}
    ...
    def full_update(
        self, branch: str = "main", update_deps: bool = True, force: bool = False
    ) -> Dict[str, Any]:
        """
        ...
        """
        results = {"pull": None, "dependencies": None, "success": False}
        ...
        if update_deps:
            ...
            if not dep_result.get("success"):
                ...
                logger.warning(
                    "Dependency update failed. Update completed but dependencies may be outdated."
                )
...
def auto_update(
    ...
    if not check_result.get("updates_available"):
        return {"success": True, "message": "Already up to date", "check": check_result}
    ...
    result = {"check": check_result, "update": update_result}
