...
"""
    ...
    def test_format_review_comment_score_emoji(self, reviewer):
        ...
        high_score = reviewer.format_review_comment(
            {"score": 9.5, "issues": [], "suggestions": [], "summary": ""}
        )
        assert "🌟" in high_score

        good_score = reviewer.format_review_comment(
            {"score": 7.5, "issues": [], "suggestions": [], "summary": ""}
        )
        assert "✅" in good_score

        medium_score = reviewer.format_review_comment(
            {"score": 5.5, "issues": [], "suggestions": [], "summary": ""}
        )
        assert "⚠️" in medium_score

        low_score = reviewer.format_review_comment(
            {"score": 3, "issues": [], "suggestions": [], "summary": ""}
        )
        assert "❌" in low_score
