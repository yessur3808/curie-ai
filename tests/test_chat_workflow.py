...
And some text after."""
    ...
    def test_sanitize_speaker_tags(self):
        ...
        sanitized_aggressive = self.workflow_aggressive._sanitize_output(
            response_with_tag
        )
    ...
    def test_sanitize_meta_notes(self):
        ...
        response_with_meta = (
            "This is helpful. [Note: This is additional context] I hope this helps!"
        )
...
You can use `api.call()` to fetch data *gestures at screen*."""
    ...
    def test_sanitize_whitespace_handling(self):
        ...
        # Test minimal mode
        sanitized_minimal = self.workflow_minimal._sanitize_output(
...
class TestMinimalSanitizationConfiguration:
    ...
    def test_minimal_sanitization_default_true(self, monkeypatch):
        ...
        minimal_sanitization = (
            os.getenv("MINIMAL_SANITIZATION", "true").lower() == "true"
        )
...
class TestSessionManagerIntegration:
    ...
    def test_batch_load_context_uses_platform_and_internal_id(self):
        ...
        with (
            patch("agent.chat_workflow.get_session_manager", return_value=mock_sm),
